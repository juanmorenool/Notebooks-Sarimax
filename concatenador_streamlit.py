"""
Módulo de concatenador de archivos Impacto para IFRS 9.
Extrae la lógica del notebook y la expone como funciones reutilizables.
"""
...
def procesar_dataframe_impacto(df: pd.DataFrame, nombre_archivo: str) -> tuple:
    ...
    3. La renombra al estándar Impacto_{producto}
...
def concatenar_impactos(dataframes_dict: dict, 
    ...
    """
    Concatena múltiples DataFrames de impacto en uno solo.
...
def procesar_archivos_impacto(archivos_cargados: list, 
    ...
    # Si no hay errores críticos, concatenar
    df_final = None
    if dataframes_dict:
        try:
        ...
        errores.append("No se pudo procesar ningún archivo")
